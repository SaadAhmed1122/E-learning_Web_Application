    ...
    <div class="col-sm-8">
        <div class="panel-body">
            <form method="post" action="./Upload_material_Servlet" onsubmit="return validate();">
                ...
                <tr> </tr>       <th> <label for="Description">Description</label></th><th>
                        <input class="form-group" name="Description" id="Description" placeholder="Description"  required></th>
                <tr>  </tr>      <th><label for="link">Link</label></th><th>
                ...
                <tr>
         <th>       <a class="btn btn-danger" href="teacher_main.jsp">Cancel</a>
