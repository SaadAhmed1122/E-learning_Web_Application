...
public class ListModelsNamesDatabase {
    /**
     * The SQL statement to be executed
     */
    private static final String STATEMENT = "SELECT name FROM amupark.model;";
    /**
     ...
     *            the connection to the database.
     */
    public ListModelsNamesDatabase(final Connection con) {
        this.con = con;
    }
     ...
     */
    public List<String> listModelsNames() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                modelsNames.add(rs.getString(1));
            }
