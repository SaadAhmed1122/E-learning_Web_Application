...
public class BuilderFilter extends AbstractFilter {

    final static Logger logger = LogManager.getLogger(BuilderFilter.class);
    ...
    public void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        if (loggedIn) {
            if (session.getAttribute("role").equals("admin")||session.getAttribute("role").equals("builder")) {
                ...
                logger.info("user "+session.getAttribute("email")+
                        ...
                        " tried to access the builder area");
