...
<%
    ...
    String query0 = "select lms_teacher.teacher_id,lms_teacher.name from lms_teacher where lms_teacher.email='" + teacher_email + "'";
    Statement st0 = con0.createStatement();

    rs0 = st0.executeQuery(query0);

    while (rs0.next()) {
        teacher_id= Integer.parseInt(rs0.getString(1));
        teacher_name= rs0.getString(2);
    }
%>
    ...
    <div class="col-sm-8">
        <div class="panel-body">
            ...
            <h1>Teacher Dashboard</h1>
                <p>Welcome, <label class="red"><%=teacher_name%>!</label>
