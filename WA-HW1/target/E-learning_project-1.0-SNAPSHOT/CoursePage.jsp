...
<center><a href="StudentPanel.jsp"><button type="button" class="btn btn-secondary btn-group-lg">Back</button></a></center>
            ...
            <div class="col-sm-8">
                <div class="panel-body">
                    ...
                    <tr>
                        ...
                        <td><a href="<%=rs.getString("img_file") %>"><%=rs.getString("img_file") %></a></td>
                    </tr>
                <%
                                  }
                        %>
